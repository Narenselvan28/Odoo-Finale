...
class RegressorService:
    ...
    def _normalize_payload(self, data):
        ...
        payload.setdefault("product_tier", "STANDARD")
        payload.setdefault("market_region", "DOMESTIC")
        payload.setdefault("optional_services", "NONE")
        payload.setdefault("selected_products_count", 1.0)
        payload.setdefault("optional_services_count", 0.0)
        payload.setdefault("optional_services_fee", 0.0)
