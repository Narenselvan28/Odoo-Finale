// ── Model Associations ────────────────────────────────────────────
// This file is imported by server.js at startup so that all Sequelize
// associations are registered before any query runs.
...
Quotation.belongsTo(Customer, { as: "Customer", foreignKey: "customer_id" });
...
Quotation.hasMany(QuotationItem, { as: "QuotationItems", foreignKey: "quotation_id", onDelete: "CASCADE" });
QuotationItem.belongsTo(Quotation, { foreignKey: "quotation_id" });
Product.hasMany(QuotationItem, { foreignKey: "product_id" });
QuotationItem.belongsTo(Product, { as: "Product", foreignKey: "product_id" });
