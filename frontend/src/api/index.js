...
export const intelligenceApi = {
  ...
  simulateWhatIf: (data) => api.post("/intelligence/what-if", data),
  simulateScenarios: (data) => api.post("/intelligence/scenarios", data),
  recommendDiscount: (data) => api.post("/intelligence/recommend-discount", data),
  predictDiscountRisk: (data) => api.post("/intelligence/discount-risk", data),
  checkHealth: () => api.get("/intelligence/health"),
};

// 💬 DealFlow360 Conversational Customer Assistant API
export const chatApi = {
  sendMessage: (data) => api.post("/intelligence/customer-chat", data),
  confirmAction: (data) => api.post("/intelligence/customer-chat/confirm", data),
  cancelAction: (data) => api.post("/intelligence/customer-chat/cancel", data),
};
